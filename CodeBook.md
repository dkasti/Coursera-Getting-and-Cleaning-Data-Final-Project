...
======================================
- A 561-feature vector with time and frequency domain variables. Each of these features is the average of the corresponding values over all the windows.
- Its activity name. 
...
These signals were used to estimate the variables, which are intrinsically the corresponding average values over all the windows, of the feature vector for each pattern:  
